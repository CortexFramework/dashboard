...
> Real-time monitoring dashboard for model performance and infrastructure health - part of the [CortexFramework](https://github.com/CortexFramework) open-source ecosystem.
...
The `dashboard` application is the web frontend for CortexFramework, built with Next.js for fast page loads, great developer experience, and easy deployment.
...
```bash
git clone https://github.com/CortexFramework/dashboard
cd dashboard
npm install
```
